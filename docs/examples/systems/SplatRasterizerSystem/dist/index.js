...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_createGuid__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_systems_DefaultCameraSystem__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__systems_SplatterSystem__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rasterizers_SplatRasterizer__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entities_PaintableEntity__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__entities_PaintableTextEntity__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_systems_BroadPhaseCollisionSystem__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_systems_CursorSystem__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_entities_Camera__ = __webpack_require__(49);
...
const cameraSystem = new __WEBPACK_IMPORTED_MODULE_1__src_systems_DefaultCameraSystem__["a" /* default */]({ canvas, cameraName });
const broadPhaseCollisionSystem = new __WEBPACK_IMPORTED_MODULE_6__src_systems_BroadPhaseCollisionSystem__["a" /* default */]();
const splatterSystem = new __WEBPACK_IMPORTED_MODULE_2__systems_SplatterSystem__["a" /* default */]();
const camera = new __WEBPACK_IMPORTED_MODULE_8__src_entities_Camera__["a" /* default */](cameraName);
const paintableEntity = new __WEBPACK_IMPORTED_MODULE_4__entities_PaintableEntity__["a" /* default */]();
const paintableTextEntity = new __WEBPACK_IMPORTED_MODULE_5__entities_PaintableTextEntity__["a" /* default */]("Daddy Loves Aydri");
const splatRasterizer = new __WEBPACK_IMPORTED_MODULE_3__rasterizers_SplatRasterizer__["a" /* default */]({canvasFactory: cameraSystem.canvasFactory});
const cursorSystem = new __WEBPACK_IMPORTED_MODULE_7__src_systems_CursorSystem__["a" /* default */]({ canvas, cameraName, document });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CameraSystem_Compositor__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CameraSystem_CanvasFactory__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CameraSystem_ImageFactory__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__CameraSystem_BitmapRasterizer__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CameraSystem_PolygonRasterizer__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__CameraSystem_LineRasterizer__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__CameraSystem_ShapeRasterizer__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__CameraSystem_TextRasterizer__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__CameraSystem__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__CameraSystem_BitmapCache__ = __webpack_require__(23);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CanvasPool__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CellRenderer__ = __webpack_require__(22);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TileToCanvasConverter__ = __webpack_require__(24);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tile__ = __webpack_require__(25);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Hit__ = __webpack_require__(27);
    ...
    handleHit(id) {
        if (this.cursorComponent.isLeftButtonDown) {
            ...
            if (entity != null) {
                ...
                if (index === -1) {
                    const hit = new __WEBPACK_IMPORTED_MODULE_0__Hit__["a" /* default */]();
                    hit.x = x;
                    hit.y = y;
                    hit.size = 20;
                    hit.color.red = 255;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SplatterSystem;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Hit;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_utilities_Noise__ = __webpack_require__(29);
...
class SplatRasterizer {
    constructor({ canvasFactory }) {
        this.type = "splat-surface";
        this.canvasFactory = canvasFactory;
        this.noise = new __WEBPACK_IMPORTED_MODULE_0__src_utilities_Noise__["a" /* default */](35272);
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SplatRasterizer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_SplatSurface__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_components_Transform__ = __webpack_require__(3);
...
class PaintableEntity extends __WEBPACK_IMPORTED_MODULE_0__src_Entity__["a" /* default */] {
    constructor() {
        super();

        const transform = new __WEBPACK_IMPORTED_MODULE_5__src_components_Transform__["a" /* default */]();
        ...
        const splatSurface = new __WEBPACK_IMPORTED_MODULE_1__components_SplatSurface__["a" /* default */]();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PaintableEntity;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_components_SpatialPartition__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_components_Transform__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_components_Text__ = __webpack_require__(33);
...
class PaintableEntity extends __WEBPACK_IMPORTED_MODULE_0__src_Entity__["a" /* default */] {
    constructor(text) {
        ...
        const rectangleCollider = new __WEBPACK_IMPORTED_MODULE_3__src_components_RectangleCollider__["a" /* default */]();
        const spatialPartition = new __WEBPACK_IMPORTED_MODULE_4__src_components_SpatialPartition__["a" /* default */]();
        const textComponent = new __WEBPACK_IMPORTED_MODULE_6__src_components_Text__["a" /* default */]();
        const splatSurface = new __WEBPACK_IMPORTED_MODULE_1__components_SplatSurface__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Rectangle__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ZIndex__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Cursor__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Transform__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_RectangleCollider__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Shape__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_SpatialPartition__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_CursorService__ = __webpack_require__(48);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Entity__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Camera__ = __webpack_require__(50);
