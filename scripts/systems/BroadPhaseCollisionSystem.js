(function () {
    ...
    class BroadPhaseCollisionSystem {
        constructor(cellSize) {
            this._dependencies = ["broad-phase-collidable"];
        ...
        cleanCollisions() {
            ...
            entities.forEach(function (entity) {
                ...
                keys = Object.keys(collisions).forEach(function (key) {
        ...
        _createBroadPhaseEntity(entity) {
            ...
            broadPhaseEntity.collidable = entity.getComponent("broad-phase-collidable");
