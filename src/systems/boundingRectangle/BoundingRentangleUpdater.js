...
export default class BoundingRectangleUpdater {
  ...
  updateBoundingRectangle() {
    ...
    this.transform.boundingRect.top = Math.floor(min.y);
    this.transform.boundingRect.left = Math.floor(min.x);
    this.transform.boundingRect.bottom = Math.ceil(max.y);
    this.transform.boundingRect.right = Math.ceil(max.x);
    this.transform.size.width =
      this.transform.boundingRect.right - this.transform.boundingRect.left;
    this.transform.size.height =
      this.transform.boundingRect.bottom - this.transform.boundingRect.top;
  }
