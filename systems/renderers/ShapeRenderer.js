define(["require", "exports"], function (require, exports) {
    ...
    var ShapeRenderer = (function () {
        ...
        ShapeRenderer.prototype.draw = function (entity, canvas, cameraPosition) {
            if (canvas == null) {
                return;
            }
            ...
            context.drawImage(entityCanvas, Math.floor(sourceX), Math.floor(sourceY), Math.floor(width), Math.floor(height), Math.floor(x), Math.floor(y), Math.floor(width), Math.floor(height));
        };
